...
export const api = {
  ...
  makeOffer: (playerId:number, fee:number) => invoke<string>("make_offer", { player_id: playerId, fee }),
  respondOffer: (offerId:number, accept:boolean) => invoke<string>("respond_offer", { offer_id: offerId, accept }),
  ...
  markRead: (msgId:number) => invoke<void>("mark_read", { msg_id: msgId }),
